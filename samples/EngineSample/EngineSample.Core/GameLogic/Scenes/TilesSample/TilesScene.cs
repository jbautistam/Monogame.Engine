...
/// </summary>
internal class TilesScene(SceneManager sceneManager, int level) : AbstractScene(sceneManager, SceneName, new Bau.BauEngine.Entities.Common.WorldDefinitionModel(5_000, 5_000, 32, 40))
{
	// Constantes públicas
