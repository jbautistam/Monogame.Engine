...
/// </summary>
public class ParticlesScene(SceneManager sceneManager) : AbstractScene(sceneManager, SceneName, new Bau.BauEngine.Entities.Common.WorldDefinitionModel(1_000, 1_000, 200, 200))
{
	// Constantes públicas
	...
	public void ShowParticles(string name, Vector2 position)
	{
		if (_particlesLayer is not null)
			_particlesLayer.ShowParticles(name, position, null);
	}
