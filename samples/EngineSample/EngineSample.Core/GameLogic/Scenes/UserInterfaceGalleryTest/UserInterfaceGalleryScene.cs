...
/// </summary>
internal class UserInterfaceGalleryScene(SceneManager sceneManager) : AbstractScene(sceneManager, SceneName, new Bau.BauEngine.Entities.Common.WorldDefinitionModel(2_000, 2_000, 200, 200))
{
	// Constantes públicas
