...
/// </summary>
internal class SpaceShipsScene(SceneManager sceneManager) : AbstractScene(sceneManager, SceneName, new Bau.BauEngine.Entities.Common.WorldDefinitionModel(5_000, 5_000, 200, 200))
{
	// Constantes públicas
