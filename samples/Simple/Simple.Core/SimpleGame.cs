...
using Simple.Core.Effects;
using Simple.Core.Localization;
using Simple.Core.Settings;
using Simple.ScreenManagers;
using Simple.Screens;
...
namespace Simple.Core
{
    ...
    public class SimpleGame : Game
    {
        ...
        private SettingsManager<SimpleSettings> settingsManager;

        // Manages leaderboard data for tracking high scores and achievements.
        private SettingsManager<SimpleLeaderboard> leaderboardManager;
        ...
        public SimpleGame()
        {
            ...
            settingsManager = new SettingsManager<SimpleSettings>(storage);
            Services.AddService(typeof(SettingsManager<SimpleSettings>), settingsManager);

            leaderboardManager = new SettingsManager<SimpleLeaderboard>(storage);
            Services.AddService(typeof(SettingsManager<SimpleLeaderboard>), leaderboardManager);
