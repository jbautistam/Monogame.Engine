...
/// <summary>
///     Clase para dibujo de un <see cref="SpriteFontDefinition"/>
/// </summary>
public class SpriteFontRenderer(SpriteFontDefinition sprite)
{
	/// <summary>
	///		Escribe una cadena
	/// </summary>
    ...
    /// </summary>
    public SpriteFontDefinition Sprite { get; } = sprite;
}