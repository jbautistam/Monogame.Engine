...
{
    public WorldCamera(CameraDirector director, string name, Vector2 origin, CameraViewport viewportConfig, int zIndex)
        : base(director, name, CameraType.World, origin, viewportConfig, zIndex)
    {
    }
