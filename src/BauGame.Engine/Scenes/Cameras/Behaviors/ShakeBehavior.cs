...
/// </summary>
public class ShakeBehavior(Definitions.AbstractCameraBase camera, float duration, float intensity = 10, float frequency = 20) : AbstractCameraBehavior(camera, duration)
{
    // Variables privadas
