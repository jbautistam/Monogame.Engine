...
/// <summary>
///     Origen de audio con un efecto de voz
/// </summary>
public class VoiceSource(SoundEffectInstance effect, List<ScheduleEvent>? scheduleEvents) : AbstractAudioSource(scheduleEvents)
{
    /// <summary>
    ///     Actualiza el sonido
    /// </summary>
