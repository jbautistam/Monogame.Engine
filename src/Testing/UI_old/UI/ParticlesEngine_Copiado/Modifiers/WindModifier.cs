...
/// </summary>
public class WindModifier(Vector2 direction, float strength, Random random, float turbulence = 0f) : AbstractParticleModifier
{
    /// <summary>
    ...
    {
        float turbulenceFactor = Math.Abs((float) (random.NextDouble() * 2 - 1) * turbulence);
