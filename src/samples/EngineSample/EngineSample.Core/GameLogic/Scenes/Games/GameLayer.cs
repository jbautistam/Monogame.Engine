...
using Bau.Monogame.Engine.Domain.Core.Actors.Particles;
using Bau.Monogame.Engine.Domain.Core.Scenes.Layers.Games;
	...
	private void EmitParticles()
	{
		if (_particlesManager is not null)
		{
			...
			Vector2 position = new(random.Next(-200, 200), random.Next(-200, 200));
				...
				{
					case 1:
							_particlesManager.Effect = new Bau.Monogame.Engine.Domain.Core.Actors.Particles.Effects.ParticlesConfettiEffect(1_000);
						break;
					case 2:
							_particlesManager.Effect = new Bau.Monogame.Engine.Domain.Core.Actors.Particles.Effects.ParticlesExplossionEffect(1_000);
						break;
					case 3:
							_particlesManager.Effect = new Bau.Monogame.Engine.Domain.Core.Actors.Particles.Effects.ParticlesFireworkEffect(1_000);
						break;
					case 4:
							_particlesManager.Effect = new Bau.Monogame.Engine.Domain.Core.Actors.Particles.Effects.ParticlesSparklesEffect(1_000);
						break;
				}
