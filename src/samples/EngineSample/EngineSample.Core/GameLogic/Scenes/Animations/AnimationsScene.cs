...
/// </summary>
internal class AnimationsScene(SceneManager sceneManager, string name) : AbstractScene(sceneManager, name, new Bau.BauEngine.Entities.Common.WorldDefinitionModel(2_000, 2_000, 200, 200))
{
	// Constantes públicas
